...
public class DefaultRoles
{
    ...
    public const string GarageOwner = nameof(GarageOwner);
    public const string GarageOwnerRoleId = "b1b8529f-44ad-4399-a2ee-9569551d5418";
    public const string GarageOwnerConcurrencyStamp = "1f40029e-885b-40e9-baf4-7a1cb4df4b23";
}
